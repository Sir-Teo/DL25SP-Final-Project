...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default="/gpfs/scratch/wz1492/DL25SP-Final-Project/runs/63447057/task2_size-tiny_d4_h4_hd32_mlp512_do0.05_sched0.5_lr8.01092e-05_loss-vicreg_s21.2008_v3.5639_c0.0274254_seed1002/model_epoch_2.pth", help="path to JEPA model checkpoint")
